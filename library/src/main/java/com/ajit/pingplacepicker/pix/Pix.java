...
import com.ajit.pingplacepicker.pix.adapters.InstantImageAdapter;
import com.ajit.pingplacepicker.pix.adapters.MainImageAdapter;
import com.ajit.pingplacepicker.pix.interfaces.OnSelectionListener;
import com.ajit.pingplacepicker.pix.interfaces.WorkFinish;
import com.ajit.pingplacepicker.pix.modals.Img;
import com.ajit.pingplacepicker.pix.utility.Constants;
import com.ajit.pingplacepicker.pix.utility.HeaderItemDecoration;
import com.ajit.pingplacepicker.pix.utility.ImageVideoFetcher;
import com.ajit.pingplacepicker.pix.utility.PermUtil;
...
public class Pix extends AppCompatActivity implements View.OnTouchListener {
    ...
    private void initialize() {
        ...
        ((CoordinatorLayout) findViewById(R.id.main_content)).setVisibility(options.isExcludeGallery() ? View.GONE : View.VISIBLE);
